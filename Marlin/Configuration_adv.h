...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu //Bookmarked
    ...
    #define X_AXIS_TWIST_COMPENSATION
      ...
      #define XATC_Z_OFFSETS { -0.09, -0.08, -0.03, 0.06 ,0.14 }    // Z offsets for X axis sample points
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping //Bookmarked
 ...
 */
  ...
  #define PROBING_MARGIN_RIGHT 32
