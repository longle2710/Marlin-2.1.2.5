...
#define STRING_CONFIG_H_AUTHOR "(Phan Long Prusa i3)" // Who made the changes.
 ...
 */
#define X_DRIVER_TYPE  TMC2209 //Bookmarked
#define Y_DRIVER_TYPE  TMC2209 //Bookmarked
#define Z_DRIVER_TYPE  TMC2209 //Bookmarked
...
#define E0_DRIVER_TYPE TMC2209 //Bookmarked
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 180.95
  #define DEFAULT_bedKi 35.63
  #define DEFAULT_bedKd 612.71
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 195 }
 ...
 */
#define Z_MIN_PROBE_PIN 20  //Bookmarked
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -29, -49.5, -0.935 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define PROBING_MARGIN 5 // (mm) 
...
#define Z_CLEARANCE_MULTI_PROBE     2.5 // (mm) Z Clearance between multiple probes
...
#endif
#define PROBING_FANS_OFF          // Turn fans off when probing //Bookmarked
#define PROBING_ESTEPPERS_OFF     // Turn all extruder steppers off when probing //Bookmarked
...
#define AUTO_BED_LEVELING_BILINEAR //Bookmarked
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5 //Bookmarked
 ...
 */
#define LCD_BED_LEVELING //bookmarked
